...
export default class IceCream extends Component {
    constructor(props){
        ...
        this.state ={
            ...
            unMarkedPositions: [
                {latitude: 40.707118, longitude: -74.010636, id: 1, text: 'Broad st and Wall st'},
                {latitude: 40.707727, longitude: -74.0011696, id: 2, text: 'Broadway and Wall st'},
                {latitude: 40.707083, longitude: -74.0011261, id: 2, text: 'Broadway and Pine st'},
                {latitude: 40.707727, longitude: -74.0011696, id: 2, text: 'Broad st and Cedar st'},
                {latitude: 40.707688, longitude: -74.008277, id: 2, text: 'William st and Liberty st'},
                {latitude: 40.706918, longitude: -74.009003, id: 2, text: 'Pine st and William st'}
                ],
            lines: [],
            counter: 0,
        }
